            ...
            <div>
                <?php if(isset($_SESSION['user_id'])): ?>
                    ...
                    <?php if(isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
                        <a href="admin.php" style="color:rgb(181, 15, 241);">TRANG QUẢN TRỊ</a>
                    <?php else: ?>
        ...
        <div class="container">
            <div style="margin: 20px 0; text-align: center;">
                <form method="GET" style="display:inline-block; width: 60%;">
                    <input type="text" name="keyword" placeholder="Tìm kiếm sản phẩm" value="<?php echo isset($_GET['keyword']) ? $_GET['keyword'] : '' ?>" style="width: 70%; display:inline-block">
